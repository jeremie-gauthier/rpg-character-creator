...
- **Skill Designer**: Deep editing for requirements, constraints, side effects, and animations.
- **Asset Preview**: Built-in sprite sheet viewer and animation previewer.
- **JSON Export**: Generates validated character definitions ready for game integration.
